...
public final class Consts {
    ...
    static String SONG_EXAMPLE = "Введите исполнителя и название песни на английском, чтобы получить текст определённой песни\nПример: Xxxtentacion jocelyn flores\n" +
    ...
    static String DEFAULT_TEXT = "Не знаю такого:(\nПроверьте правильность написанного.";
}
